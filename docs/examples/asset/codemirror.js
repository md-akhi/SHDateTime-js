!(function (e, t) {
	...
	var ue = (function () {
		...
		return function (s, u) {
			...
			for (var f, d = s.length, h = [], p = 0; p < d; ++p)
				h.push(
			...
			for (var w = 1, C = h[0]; w < d - 1; ++w) {
				var k = h[w];
				"+" == k && "1" == C && "1" == h[w + 1]
					? (h[w] = "1")
					: "," != k || C != h[w + 1] || ("1" != C && "n" != C) || (h[w] = C),
					(C = k);
			}
			for (var S = 0; S < d; ++S) {
				var L = h[S];
			...
			for (var A = 0, O = c; A < d; ++A) {
				var D = h[A];
				"L" == O && "1" == D ? (h[A] = "L") : i.test(D) && (O = D);
			}
			for (var W = 0; W < d; ++W)
				if (n.test(h[W])) {
					var E = void 0;
					for (E = W + 1; E < d && n.test(h[E]); ++E);
					for (
						var H = "L" == (W ? h[W - 1] : c),
							F = H == ("L" == (E < d ? h[E] : c)) ? (H ? "L" : "R") : c,
							P = W;
						P < E;
						++P
					)
			...
			for (var z, I = [], R = 0; R < d; )
				if (o.test(h[R])) {
					...
					for (var G = B; G < R; )
						if (l.test(h[G])) {
							B < G && (I.splice(j, 0, new a(1, B, G)), (j += V));
							var U = G;
							for (++G; G < R && l.test(h[G]); ++G);
							I.splice(j, 0, new a(2, U, G)), (j += V), (B = G);
						} else ++G;
					B < R && I.splice(j, 0, new a(1, B, R));
				}
			return (
				"ltr" == u &&
					(1 == I[0].level &&
						(z = s.match(/^\s+/)) &&
						((I[0].from = z[0].length), I.unshift(new a(0, 0, z[0].length))),
					1 == X(I).level &&
						(z = s.match(/\s+$/)) &&
						((X(I).to -= z[0].length), I.push(new a(0, d - z[0].length, d)))),
				"rtl" == u ? I.reverse() : I
			);
		};
	})();
		...
		if (null == Me) {
			...
			N(e, A("span", [t, document.createTextNode("x")])),
				0 != e.firstChild.offsetHeight &&
					(Me = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(l && a < 8));
		}
		var r = Me
			? A("span", "​")
			: A(
	...
	function Oe(e) {
		...
		return T(e), !(!r || r.left == r.right) && (Te = n.right - r.right < 3);
	}
	var De,
		We =
			3 != "\n\nb".split(/\n/).length
	...
	function Ye(e) {
		...
		for (
			var t = e.parent, r = _(t.lines, e), n = t.parent;
			n;
			t = n, n = n.parent
		)
		...
		var o = (function (e, t, r) {
				for (
					...
					if (
						...
						return a;
					var c = I(s.text, null, e.options.tabSize);
	...
	(ct.prototype.lookAhead = function (e) {
		...
		(ct.fromSaved = function (e, t, r) {
			return t instanceof ut
				? new ct(e, je(e.mode, t.state), r, t.lookAhead)
				: new ct(e, je(e.mode, t), r);
		}),
	...
	function yt(e, t, r, n) {
		...
		for (n && (o = []); (n || c.pos < t.ch) && !c.eol(); )
			(c.start = c.pos),
				(i = mt(a, c, u.state)),
				n && o.push(new vt(c, i, je(l.mode, u.state)));
	...
	function Mt(e, t) {
		...
		var r = Qe(e, t.from.line) && Ke(e, t.from.line).markedSpans,
			n = Qe(e, t.to.line) && Ke(e, t.to.line).markedSpans;
		if (!r && !n) return null;
		var i = t.from.ch,
			o = t.to.ch,
			l = 0 == tt(t.from, t.to),
		...
		if (!u) {
			...
			if (y > 0 && a)
				for (var b = 0; b < a.length; ++b)
					null == a[b].to &&
						(v || (v = [])).push(new kt(a[b].marker, null, null));
	...
	function jt(e, t, r) {
		if (null == r.to) {
			...
			return jt(e, n.line, St(n.line.markedSpans, r.marker));
		}
	...
	function Vt(e) {
		for (var t = 0, r = (e = It(e)).parent, n = 0; n < r.lines.length; ++n) {
			var i = r.lines[n];
			if (i == e) break;
			t += i.height;
		}
			...
			(n.pos = 0),
				...
				o.styleClasses &&
					(o.styleClasses.bgClass &&
						(n.bgClass = H(o.styleClasses.bgClass, n.bgClass || "")),
				...
				for (var h = 0; ; ) {
					...
					if ("\t" == p[0]) {
						var y = e.cm.options.tabSize,
							b = y - (e.col % y);
						(v = u.appendChild(A("span", $(b), "cm-tab"))).setAttribute(
							"role",
							"presentation"
						),
	...
	function rr(e, t, r) {
		...
		if (n)
			for (
				var l, a, s, u, c, f, d, h = i.length, p = 0, g = 1, m = "", v = 0;
				;

			) {
				if (v == p) {
					(s = u = c = a = ""), (d = null), (f = null), (v = 1 / 0);
					for (var y = [], b = void 0, x = 0; x < n.length; ++x) {
						...
						if ("bookmark" == C.type && w.from == p && C.widgetNode) y.push(C);
							...
							C.collapsed && (!f || Wt(f.marker, C) < 0) && (f = w);
				...
				for (var M = Math.min(h, v); ; ) {
					...
					(m = i.slice(o, (o = r[g++]))), (l = Yt(r[g++], t.cm.options));
				}
			}
		else
	...
	var Er,
		Hr = { left: 0, right: 0, top: 0, bottom: 0 };
	function Fr(e, t, r) {
	...
	function jr(e) {
		var t = It(e).widgets,
			r = 0;
		if (t) for (var n = 0; n < t.length; ++n) t[n].above && (r += xr(t[n]));
		return r;
	}
	function Vr(e, t, r, n, i) {
		...
		if (
			...
			l += a.top + ("window" == n ? 0 : Br());
			var s = a.left + ("window" == n ? 0 : _r());
			(r.left += s), (r.right += s);
		}
	...
	function Ur(e, t, r, n, i) {
		return n || (n = Ke(e.doc, t.line)), Vr(e, n, Ar(e, n, t.ch, i), r);
	}
	...
	function Xr(e, t, r) {
		var n = e.doc;
		if ((r += e.display.viewOffset) < 0) return $r(n.first, 0, null, -1, -1);
		var i = Ze(n, r),
			o = n.first + n.size - 1;
		if (i > o)
			return $r(n.first + n.size - 1, Ke(n, o).text.length, null, 1, 1);
		t < 0 && (t = 0);
		for (var l = Ke(n, i); ; ) {
			var a = Jr(e, l, i, t, r),
	...
	function Zr(e, t, r, n) {
		return r || (r = Dr(e, t)), Yr(e, t, r, Vr(e, t, Wr(e, r, n), "line").top);
	}
	function Qr(e, t, r, n) {
			...
			u || (m != s && m != a) || m++,
				(h =
					0 == m
						...
						: m == t.text.length
						? "before"
						: Wr(e, o, m - (u ? 1 : 0)).bottom + l <= i == u
						? "after"
						: "before");
			var x = Kr(e, et(r, m, h), "line", t, o);
			(d = x.left), (v = i < x.top ? -1 : i >= x.bottom ? 1 : 0);
		}
		return $r(r, (m = oe(t.text, m, 1)), h, v, n - d);
	}
	function en(e) {
			...
			if (t || a != r.sel.primIndex) {
				...
				if (
					...
					if (l) {
						var c = l(e, s);
						c && mn(e, c, i);
					} else (u || e.options.showCursorWhenSelecting) && mn(e, s.head, i);
					u || yn(e, s, o);
				}
			}
		return n;
	...
	function yn(e, t, r) {
		...
		if (d.line == h.line) f(d.line, d.ch, h.ch);
			...
			m &&
				(v.top < y.top - 2
					? (c(v.right, v.top, null, v.bottom), c(a, y.top, y.left, y.bottom))
		...
		(e.state.delayingBlurEvent = !0),
			setTimeout(function () {
				e.state.delayingBlurEvent &&
					((e.state.delayingBlurEvent = !1), e.state.focused && kn(e));
			}, 100);
	}
	function Cn(e, t) {
		e.state.delayingBlurEvent &&
	...
	function Sn(e) {
		for (
			...
			if (!u.hidden) {
				...
				if (
					(g > 0.005 || g < -0.005) &&
					(i < n && (o -= g), Xe(u.line, f), Ln(u.line), u.rest)
				)
					for (var m = 0; m < u.rest.length; m++) Ln(u.rest[m]);
				if (d > e.display.sizerWidth) {
					var v = Math.ceil(d / tn(e.display));
	...
	function Mn(e, t, r) {
		...
		if (r && r.ensure) {
			var a = r.ensure.from.line,
				s = r.ensure.to.line;
			a < o
				? ((o = a), (l = Ze(t, Vt(Ke(t, a)) + e.wrapper.clientHeight)))
				: Math.min(s, t.lastLine()) >= l &&
				  ((o = Ze(t, Vt(Ke(t, s)) - e.wrapper.clientHeight)), (l = s));
		}
	...
	function Dn(e) {
		...
		t &&
			...
			Wn(e, qr(e, t.from), qr(e, t.to), t.margin));
	}
	function Wn(e, t, r, n) {
		var i = Tn(e, {
	...
	function En(e, t) {
		Math.abs(e.doc.scrollTop - t) < 2 ||
			(r || oi(e, { top: t }), Hn(e, t, !0), r && oi(e), ei(e, 100));
	}
	function Hn(e, t, r) {
		(t = Math.max(
			0,
		...
		t &&
			(function (e, t) {
				...
				!(function (e) {
					...
					for (var l = 0; l < t.length; l++) $n(t[l]);
	...
	function Xn(e) {
		...
		null != e.scrollTop && Hn(t, e.scrollTop, e.forceScroll),
			...
			(function (e, t) {
				...
				(function (e, t, r, n) {
					...
					null == n && (n = 0),
						e.options.lineWrapping ||
							t != r ||
							((r = "before" == t.sticky ? et(t.line, t.ch + 1, "before") : t),
							(t = t.ch
	...
	function ni(e, t) {
		...
		!(function (e, t, r) {
			...
			(r.viewOffset = Vt(Ke(e.doc, r.viewFrom))),
			...
			(function (e, t, r) {
				...
				for (var u = n.view, c = n.viewFrom, f = 0; f < u.length; f++) {
					...
					if (d.hidden);
						...
						d.changes &&
							(_(d.changes, "gutter") > -1 && (h = !1), ur(e, d, c, r)),
							h &&
								(T(d.lineNumber),
	...
	function ii(e, t) {
		for (var r = t.viewport, n = !0; ; n = !1) {
			if (n && e.options.lineWrapping && t.oldDisplayWidth != Mr(e))
				n && (t.visible = Mn(e.display, e.doc, r));
			else if (
				(r &&
					null != r.top &&
	...
	function vi(e, t) {
		...
		if ((i && c) || (o && d)) {
			if (o && y && s)
				e: for (var h = t.target, p = a.view; h != u; h = h.parentNode)
			...
			if (i && !r && !f && null != l)
				return (
					o && d && En(e, Math.max(0, u.scrollTop + o * l)),
					Fn(e, Math.max(0, u.scrollLeft + i * l)),
					(!o || (o && d)) && xe(t),
			...
			if (o && null != l) {
				...
				m < 0
					? (v = Math.max(0, v + m - 50))
					: (b = Math.min(e.doc.height, b + m + 50)),
					oi(e, { top: v, bottom: b });
			}
			hi < 20 &&
				0 !== t.deltaMode &&
					  ...
					  setTimeout(function () {
							if (null != a.wheelStartX) {
								...
								(a.wheelStartX = a.wheelStartY = null),
									r && ((pi = (pi * hi + r) / (hi + 1)), ++hi);
							}
					  }, 200))
					: ((a.wheelDX += i), (a.wheelDY += o)));
		}
	}
	l ? (pi = -0.53) : r ? (pi = 15) : c ? (pi = -0.7) : d && (pi = -1 / 3);
	var yi = function (e, t) {
	...
	function Ai(e, t, r, n) {
		...
		if (t.full)
			...
			if (1 == u.length)
				o(c, c.text.slice(0, a.ch) + d + c.text.slice(s.ch), h);
			else {
				var m = l(1, u.length - 1);
				m.push(new Kt(d + c.text.slice(s.ch), h, n)),
	...
	function Hi(e, t) {
		var r = { from: nt(t.from), to: Ci(t), text: qe(e, t.from, t.to) };
		return (
	...
	function Gi(e, t, r, n, i) {
		null == i && (i = e.cm && (e.cm.display.shift || e.extend)),
			Xi(e, new yi([Vi(e.sel.primary(), t, r, i)], 0), n);
	}
	function Ui(e, t, r) {
		for (
			...
			n[o] = Vi(e.sel.ranges[o], t[o], null, i);
	...
	function Xi(e, t, r) {
		Yi(e, t, r), zi(e, e.sel, e.cm ? e.cm.curOp.id : NaN, r);
	}
	function Yi(e, t, r) {
		...
		if (o.markedSpans)
			for (var l = 0; l < o.markedSpans.length; ++l) {
				...
				if (
					...
					return (
						(n < 0 ? u : c) && (h = ro(e, h, n, h.line == t.line ? o : null)),
						h ? eo(e, h, t, n, i) : null
					);
				}
			}
	...
	function ro(e, t, r, n) {
		return r < 0 && 0 == t.ch
			? t.line > e.first
				? at(e, et(t.line - 1))
				: null
			: r > 0 && t.ch == (n || Ke(e, t.line)).text.length
	...
	function lo(e, t) {
		if (1 != t.text.length || "" != t.text[0] || 0 != tt(t.from, t.to)) {
			var r = Si(e, t);
			Pi(e, t, r, e.cm ? e.cm.curOp.id : NaN), uo(e, t, r, Mt(e, t));
			var n = [];
			Oi(e, function (e, r) {
				r || -1 != _(n, e.history) || (po(e.history, t), n.push(e.history)),
					uo(e, t, null, Mt(e, t));
			});
		}
	}
				...
				e.cm
					? (function (e, t, r) {
							...
							if (f || c) {
								...
								f && ar(e, "change", e, d),
									c &&
										(e.curOp.changeObjs || (e.curOp.changeObjs = [])).push(d);
							}
	...
	function go(e, t, r, n) {
		var i = t,
			o = t;
		return (
			"number" == typeof t ? (o = Ke(e, lt(e, t))) : (i = Ye(t)),
					...
					if (e <= o) {
						if ((i.insertInner(e, t, r), i.lines && i.lines.length > 50)) {
							for (
								...
								var s = new mo(i.lines.slice(a, (a += 25)));
								(i.height -= s.height),
	...
	(yo.prototype.clear = function () {
		...
		(yo.prototype.changed = function () {
			...
			var i = xr(this) - t;
			i &&
				(Bt(this.doc, n) || Xe(n, n.height + i),
				r &&
					Yn(r, function () {
						(r.curOp.forceUpdate = !0),
							bo(r, n, i),
							ar(r, "lineWidgetChanged", r, e, Ye(n));
					}));
		}),
		be(yo);
	var xo = 0,
	...
	function Co(e, t, r, n, i) {
		...
		var o = new wo(e, i),
			l = tt(t, r);
		if ((n && z(n, o, !1), l > 0 || (0 == l && !1 !== o.clearWhenEmpty)))
			return o;
		if (
			(o.replacedWith &&
				((o.collapsed = !0),
			...
			if (
				zt(e, t.line, t, r, o) ||
				(t.line != r.line && zt(e, r.line, t, r, o))
			)
				throw new Error(
	...
	(wo.prototype.clear = function () {
		if (!this.explicitlyCleared) {
			...
			for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
				...
				e && !this.collapsed
					? cn(e, Ye(l), "text")
					: e && (null != a.to && (i = Ye(l)), null != a.from && (n = Ye(l))),
		...
		(wo.prototype.find = function (e, t) {
			...
			for (var i = 0; i < this.lines.length; ++i) {
				...
				if (null != l.from && ((r = et(t ? o : Ye(o), l.from)), -1 == e))
					return r;
		...
		(wo.prototype.changed = function () {
			...
			t &&
				...
				Yn(n, function () {
					...
					if (
						(l &&
							(zr(l), (n.curOp.selectionChanged = n.curOp.forceUpdate = !0)),
						(n.curOp.updateMaxLine = !0),
						!Bt(r.doc, i) && null != r.height)
					) {
						var a = r.height;
						r.height = null;
						var s = xr(r) - a;
		...
		for (
			var t = function (t) {
					...
					for (var i = 0; i < r.markers.length; i++) {
						var o = r.markers[i];
						-1 == _(n, o.doc) && ((o.parent = null), r.markers.splice(i--, 1));
					}
				},
				r = 0;
			r < e.length;
	...
	var Mo = 0,
		To = function (e, t, r, n, i) {
			...
			null == r && (r = 0),
				vo.call(this, [new mo([new Kt("", null)])]),
				(this.first = r),
	...
	(To.prototype = Q(vo.prototype, {
		...
		getRange: function (e, t, r) {
			var n = qe(this, at(this, e), at(this, t));
			return !1 === r
				? n
				: "" === r
				? n.join("")
		...
		addLineWidget: Jn(function (e, t, r) {
			return (function (e, t, r, n) {
				...
				return (
					...
					o && ar(o, "lineWidgetAdded", o, i, "number" == typeof t ? t : Ye(t)),
					i
				);
			})(this, e, t, r);
		}),
							...
							s = function () {
								++a == i &&
									Zn(t, function () {
										...
										oo(t.doc, e), $i(t.doc, wi(at(t.doc, r), at(t.doc, Ci(e))));
									})();
							},
							u = function (e, r) {
								if (
						...
						if (f) {
							...
							if (
								...
								for (var h = 0; h < d.length; ++h)
									co(t.doc, "", d[h].anchor, d[h].head, "drag");
	...
	for (var zo = 65; zo <= 90; zo++) Fo[zo] = String.fromCharCode(zo);
	...
	function Bo(e) {
		...
		for (var r in e)
			if (e.hasOwnProperty(r)) {
				...
				for (var i = Y(r.split(" "), _o), o = 0; o < i.length; o++) {
					var l = void 0,
						a = void 0;
					o == i.length - 1
						? ((a = i.join(" ")), (l = n))
	...
	function Uo(e, t) {
		...
		return (
			null != r &&
			!e.altGraphKey &&
			(3 == e.keyCode && e.code && (r = e.code), Go(r, e, t))
		);
	}
	function Ko(e) {
	...
	function sl(e) {
		...
		if (
			...
			var r = e.keyCode,
				n = e.charCode;
			if (f && r == ol) return (ol = null), void xe(e);
					...
					(n &&
						...
						(1 == i
							? n
										...
										(tt(i.to(), t) > 0 || t.xRel < 0)
											...
											: (function (e, t, r, n) {
													...
													if ("rectangle" == n.unit)
														...
														var f = hl(e, r, n.unit);
														a = n.extend
															? Vi(a, f.anchor, f.head, n.extend)
															: f;
													}
													n.addNew
														? -1 == s
															? ((s = c.length),
															  Xi(o, xi(e, c.concat([a]), s), {
																	scroll: !1,
																	origin: "*mouse"
															  }))
															: c.length > 1 &&
														...
														if (0 != tt(d, t))
															if (((d = t), "rectangle" == n.unit)) {
																for (
																	var i = [],
																		l = e.options.tabSize,
																		c = I(Ke(o, r.line).text, r.ch, l),
																		f = I(Ke(o, t.line).text, t.ch, l),
																		h = Math.min(c, f),
																		p = Math.max(c, f),
																	...
																	h == p
																		...
																		: v.length > y &&
																		  i.push(
																				new bi(et(g, y), et(g, K(v, p, l)))
																		  );
																}
																i.length || i.push(new bi(r, r)),
																	Xi(
																		o,
																		xi(e, u.ranges.slice(0, s).concat(i), s),
																...
																var b,
																	...
																	C = x.anchor;
																tt(w.anchor, C) > 0
																	? ((b = w.head), (C = ot(x.from(), w.anchor)))
																	: ((b = w.anchor), (C = it(x.to(), w.head)));
								...
								: Se(e) == r.scroller && xe(e)
							: 2 == i
							? (n && Gi(t.doc, n),
							  setTimeout(function () {
									return r.input.focus();
							  }, 20))
							: 3 == i && (k ? t.display.input.onContextMenu(e) : wn(t)));
			}
	}
	function hl(e, t, r) {
	...
	function kl(e, t) {
		...
		(this.options = t = t ? z(t) : {}), z(bl, t, !1);
		var i = t.value;
		"string" == typeof i
			? (i = new To(i, t.mode, null, t.lineSeparator, t.direction))
		...
		(function (e) {
			var t = e.display;
			de(t.scroller, "mousedown", Zn(e, dl)),
				de(
					t.scroller,
					"dblclick",
					l && a < 11
			...
			de(s, "keyup", function (t) {
				...
				de(s, "keydown", Zn(e, ll)),
				de(s, "keypress", Zn(e, sl)),
		...
		(t.autofocus && !v) || this.hasFocus()
			...
			: kn(this),
		xl))
			xl.hasOwnProperty(c) && xl[c](this, t[c], yl);
		ui(this), t.finishInit && t.finishInit(this);
		for (var h = 0; h < Sl.length; ++h) Sl[h](this);
		Un(this),
			s &&
				t.lineWrapping &&
	...
	(kl.defaults = bl), (kl.optionHandlers = xl);
	var Sl = [];
	function Ll(e, t, r, n) {
		var i,
			o = e.doc;
		null == r && (r = "add"),
			"smart" == r && (o.mode.indent ? (i = ht(e, t).state) : (r = "prev"));
		...
		if (n || /\S/.test(a.text)) {
			if (
				"smart" == r &&
				((u = o.mode.indent(i, a.text.slice(c.length), a.text)) == j || u > 150)
			) {
				if (!n) return;
				r = "prev";
			}
		...
		"prev" == r
			? (u = t > o.first ? I(Ke(o, t - 1).text, null, l) : 0)
			: "add" == r
	...
	function Nl(e, t, r, n, i) {
		...
		for (var f = e.curOp.updateInput, d = n.ranges.length - 1; d >= 0; d--) {
			var h = n.ranges[d],
				p = h.from(),
				g = h.to();
			h.empty() &&
				(r && r > 0
					...
					? (g = et(
							g.line,
							Math.min(Ke(o, g.line).text.length, g.ch + X(s).length)
					  ))
					: a &&
					  Ml &&
					  Ml.lineWise &&
	...
	function Hl(e, t, r, n, i) {
		...
		function u(o) {
			var l, u;
			if ("codepoint" == n) {
				var c = a.text.charCodeAt(t.ch + (r > 0 ? 0 : -1));
				if (isNaN(c)) l = null;
				else {
					var f = r > 0 ? c >= 55296 && c < 56320 : c >= 56320 && c < 57343;
					l = new et(
						t.line,
						Math.max(0, Math.min(a.text.length, t.ch + r * (f ? 2 : 1))),
						-r
					);
				}
			} else
				l = i
					? (function (e, t, r, n) {
							...
							if ("rtl" == e.doc.direction || 1 == l.level) {
								...
								if (
									null != d &&
									(f ? d <= l.to && d <= c.end : d >= l.from && d >= c.begin)
								) {
									var h = f ? "before" : "after";
									return new et(r.line, d, h);
								}
							}
			...
			if (null == l) {
				if (
					...
					(u = t.line + s) < e.first ||
					u >= e.first + e.size ||
					((t = new et(u, t.ch, t.sticky)), !(a = Ke(e, u)))
				)
					return !1;
				t = Yo(i, e.cm, a, t.line, s);
			} else t = l;
			return !0;
		}
	...
	function Rl(e, t, r) {
		...
		if (t == e.display.lineDiv) {
			if (!(n = e.display.lineDiv.childNodes[r]))
				return Il(e.clipPos(et(e.display.viewTo - 1)), !0);
			(t = null), (r = 0);
		} else
	...
	function _l(e, t, r) {
		var n = e.text.firstChild,
			i = !1;
		if (!t || !D(n, t)) return Il(et(Ye(e.line), 0), !0);
		if (t == n && ((i = !0), (t = n.childNodes[r]), (r = 0), !t)) {
			var o = e.rest ? X(e.rest) : e.line;
			return Il(et(Ye(o), o.text.length), i);
		}
		...
		if (f) return Il(f, i);
		for (
			var d = a.nextSibling, h = l ? l.nodeValue.length - r : 0;
			d;
			d = d.nextSibling
		) {
			if ((f = c(d, d.firstChild, 0))) return Il(et(f.line, f.ch - h), i);
			h += d.textContent.length;
		}
		for (var p = a.previousSibling, g = r; p; p = p.previousSibling) {
			if ((f = c(p, p.firstChild, -1))) return Il(et(f.line, f.ch + g), i);
	...
	(Pl.prototype.init = function (e) {
		...
		function l(e) {
			if (o(e) && !me(n, e)) {
				if (n.somethingSelected())
					Tl({ lineWise: !1, text: n.getSelections() }),
		...
		(Pl.prototype.pollContent = function () {
			...
			if (
				(0 == l.ch &&
					l.line > n.firstLine() &&
					(l = et(l.line - 1, Ke(n.doc, l.line - 1).length)),
				a.ch == Ke(n.doc, a.line).text.length &&
					a.line < n.lastLine() &&
					(a = et(a.line + 1, 0)),
			...
			for (
				var f = n.doc.splitLines(
					...
					d = qe(n.doc, et(t, 0), et(s, Ke(n.doc, s).text.length));
			...
			for (
				var h = 0, p = 0, g = f[0], m = d[0], v = Math.min(g.length, m.length);
			...
			return f.length > 1 || f[0] || tt(w, C)
				? (co(n.doc, f, w, C, "+input"), !0)
				: void 0;
		}),
	...
	(Bl.prototype.init = function (e) {
		...
		(Bl.prototype.createField = function (e) {
			(this.wrapper = El()), (this.textarea = this.wrapper.firstChild);
		}),
		...
		(Bl.prototype.showSelection = function (e) {
		...
		(Bl.prototype.slowPoll = function () {
			var e = this;
			this.pollingFast ||
		...
		(Bl.prototype.fastPoll = function () {
			var e = !1,
				t = this;
			(t.pollingFast = !0),
		...
		(Bl.prototype.onKeyPress = function () {
			l && a >= 9 && (this.hasSelection = null), this.fastPoll();
		}),
		(Bl.prototype.onContextMenu = function (e) {
			var t = this,
				r = t.cm,
				n = r.display,
				i = t.textarea;
			...
			if (o && !f) {
				...
				if (
					...
					ke(e);
					var g = function () {
						pe(window, "mouseup", g), setTimeout(v, 20);
					};
					de(window, "mouseup", g);
		...
		(Bl.prototype.setUneditable = function () {}),
		(Bl.prototype.needsContentAttribute = !1),
		(function (e) {
			...
			(e.prototype = {
					...
					for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
						...
						if (i.empty())
							...
							0 == o.ch &&
								t.length == u.length &&
								u[n].from().ch > 0 &&
								Ki(this.doc, n, new bi(o, u[n].to()), V);
						}
					}
				}),
				...
				getHelpers: function (e, t) {
					...
					for (var s = 0; s < i._global.length; s++) {
						var u = i._global[s];
						u.pred(o, this) && -1 == _(n, u.val) && n.push(u.val);
					}
					return n;
				},
				...
				addWidget: function (e, t, r, n, i) {
					...
					(t.style.top = u + "px"),
						...
						r &&
							...
							null != (a = Tn(o, l)).scrollTop && En(o, a.scrollTop),
				...
				findPosH: function (e, t, r, n) {
					...
					for (
						...
						l < t && !(o = Hl(this.doc, o, i, r, n)).hitSide;
						++l
					);
					return o;
				},
				moveH: Qn(function (e, t) {
					...
					this.extendSelectionsBy(function (n) {
						return r.display.shift || r.doc.extend || n.empty()
							? Hl(r.doc, n.head, e, t, r.options.rtlMoveVisually)
							: e < 0
							? n.from()
							: n.to();
					}, U);
	...
	for (var Vl in To.prototype)
		To.prototype.hasOwnProperty(Vl) &&
			_(jl, Vl) < 0 &&
			(kl.prototype[Vl] = (function (e) {
				return function () {
	...
	return (
		be(To),
		(kl.inputStyles = { textarea: Bl, contenteditable: Pl }),
	...
	(function (e) {
		...
		e.defineMode("javascript", function (t, r) {
			...
			function m(e, t) {
				...
				if ("#" == n && e.eatWhile(f)) return g("variable", "property");
				if (
					("<" == n && e.match("!--")) ||
						...
						if ("var" == t.lexical.info && t.context && t.context.block) {
							var n = (function e(t, r) {
								if (r) {
									if (r.block) {
										var n = e(t, r.prev);
										return n ? (n == r.prev ? r : new D(n, r.vars, !0)) : null;
									}
									return N(t, r.vars) ? r : new D(r.prev, new W(t, r.vars), !1);
								}
								return null;
							})(e, t.context);
							if (null != n) return void (t.context = n);
						} else if (!N(e, t.localVars))
							return void (t.localVars = new W(e, t.localVars));
					r.globalVars &&
						!N(e, t.globalVars) &&
						(t.globalVars = new W(e, t.globalVars));
				}
			}
			function O(e) {
				return (
			...
			function H() {
				(L.state.context = new D(L.state.context, L.state.localVars, !1)),
					(L.state.localVars = E);
			}
			function F() {
				(L.state.context = new D(L.state.context, L.state.localVars, !0)),
					(L.state.localVars = null);
			}
			function P() {
				(L.state.localVars = L.state.context.vars),
					(L.state.context = L.state.context.prev);
			}
			function z(e, t) {
				var r = function () {
					var r = L.state,
			...
			function _(e, t) {
				return "var" == e
					...
					? T()
					: "if" == e
					? ("else" == L.state.lexical.info &&
							L.state.cc[L.state.cc.length - 1] == I &&
							L.state.cc.pop()(),
					  T(z("form"), G, _, I, Oe))
					: "function" == e
					? T(He)
					...
					? ((L.marked = "keyword"), T(z("form", "class" == e ? e : t), Re, I))
					: "variable" == e
					? c && "declare" == t
						? ((L.marked = "keyword"), T(_))
						: c &&
						  ("module" == t || "enum" == t || "type" == t) &&
						  L.stream.match(/^\s*\w/, !1)
						? ((L.marked = "keyword"),
						  "enum" == t
								? T(Ze)
								: "type" == t
								? T(Pe, R("operator"), he, R(";"))
								: T(z("form"), Le, R("{"), z("}"), se, I, I))
						: c && "namespace" == t
						? ((L.marked = "keyword"), T(z("form"), j, _, I))
						: c && "abstract" == t
						? ((L.marked = "keyword"), T(_))
						: T(z("stat"), te)
					: "switch" == e
					? T(z("form"), G, R("{"), z("}", "switch"), F, se, I, I, P)
					: "case" == e
					? T(j, R(":"))
					: "default" == e
					? T(R(":"))
			...
			function G(e) {
				return "(" != e ? M() : T(z(")"), K, R(")"), I);
			}
			function U(e, t, r) {
				if (L.state.fatArrowAt == L.stream.start) {
					var n = r ? Q : Z;
					if ("(" == e) return T(H, z(")"), le(ze, ")"), I, R("=>"), n, P);
					if ("variable" == e) return M(H, Le, R("=>"), n, P);
				}
				var i = r ? $ : q;
				return w.hasOwnProperty(e)
					...
					? T(He, i)
					: "class" == e || (c && "interface" == t)
					? ((L.marked = "keyword"), T(z("form"), Ie, I))
					: "keyword c" == e || "async" == e
					? T(r ? V : j)
					: "(" == e
					? T(z(")"), K, R(")"), I, i)
			...
			function Y(e) {
				if ("}" == e)
					return (L.marked = "string-2"), (L.state.tokenize = y), T(X);
			}
			function Z(e) {
				return x(L.stream, L.state), M("{" == e ? _ : j);
			}
			function Q(e) {
				return x(L.stream, L.state), M("{" == e ? _ : V);
			}
			function J(e, t) {
				if ("target" == t) return (L.marked = "keyword"), T(q);
			}
			function ee(e, t) {
				if ("target" == t) return (L.marked = "keyword"), T($);
			}
			function te(e) {
				return ":" == e ? T(I, _) : M(q, R(";"), I);
			}
			function re(e) {
				if ("variable" == e) return (L.marked = "property"), T();
			}
			function ne(e, t) {
				if ("async" == e) return (L.marked = "property"), T(ne);
				if ("variable" == e || "keyword" == L.style) {
					return (
						(L.marked = "property"),
						"get" == t || "set" == t
							? T(ie)
							: (c &&
									...
									(r = L.stream.match(/^\s*:\s*/, !1)) &&
									(L.state.fatArrowAt = L.stream.pos + r[0].length),
							  T(oe))
					);
					var r;
				} else {
					if ("number" == e || "string" == e)
						return (L.marked = a ? "property" : L.style + " property"), T(oe);
					if ("jsonld-keyword" == e) return T(oe);
					if (c && O(t)) return (L.marked = "keyword"), T(ne);
					if ("[" == e) return T(j, ue, R("]"), oe);
					if ("spread" == e) return T(V, oe);
					if ("*" == t) return (L.marked = "keyword"), T(ne);
					if (":" == e) return M(oe);
				}
			}
			function ie(e) {
				return "variable" != e ? M(oe) : ((L.marked = "property"), T(He));
			}
			function oe(e) {
				return ":" == e ? T(V) : "(" == e ? M(He) : void 0;
			}
			function le(e, t, r) {
				function n(i, o) {
					if (r ? r.indexOf(i) > -1 : "," == i) {
						var l = L.state.lexical;
						return (
			...
			function ce(e, t) {
				if (c && (":" == e || "in" == t)) return T(he);
			}
			function fe(e) {
				if (c && ":" == e)
					return L.stream.match(/^\s*\w+\s+is\b/, !1) ? T(j, de, he) : T(he);
			}
			function de(e, t) {
				if ("is" == t) return (L.marked = "keyword"), T();
			}
			function he(e, t) {
				return "keyof" == t || "typeof" == t || "infer" == t || "readonly" == t
					? ((L.marked = "keyword"), T("typeof" == t ? V : he))
					: "variable" == e || "void" == t
					? ((L.marked = "type"), T(xe))
					: "|" == t || "&" == t
					? T(he)
			...
			function me(e, t) {
				return "variable" == e || "keyword" == L.style
					? ((L.marked = "property"), T(me))
					: "?" == t || "number" == e || "string" == e
					? T(me)
					: ":" == e
					? T(he)
					: "[" == e
					? T(R("variable"), ce, R("]"), me)
					: "(" == e
					? M(Fe, me)
					: e.match(/[;\}\)\],]/)
					? void 0
			...
			function ye(e) {
				if ("}" == e)
					return (L.marked = "string-2"), (L.state.tokenize = y), T(ve);
			}
			function be(e, t) {
				return ("variable" == e && L.stream.match(/^\s*[?:]/, !1)) || "?" == t
					? T(be)
					: ":" == e
					? T(he)
					: "spread" == e
			...
			function xe(e, t) {
				return "<" == t
					...
					? ((L.marked = "keyword"), T(he))
					: "?" == t
					? T(he, R(":"), he)
					: void 0;
			}
			function we(e, t) {
				if ("<" == t) return T(z(">"), le(he, ">"), I, xe);
			}
			function Ce() {
				return M(he, ke);
			}
			...
			function Se(e, t) {
				return "enum" == t
					? ((L.marked = "keyword"), T(Ze))
					: M(Le, ue, Ne, Ae);
			}
			function Le(e, t) {
				return c && O(t)
					? ((L.marked = "keyword"), T(Le))
					: "variable" == e
					? (A(t), T())
					: "spread" == e
					? T(Le)
			...
			function Me(e, t) {
				return "variable" != e || L.stream.match(/^\s*:/, !1)
					? ("variable" == e && (L.marked = "property"),
					  "spread" == e
							? T(Le)
							: "}" == e
							? M()
			...
			function Oe(e, t) {
				if ("keyword b" == e && "else" == t) return T(z("form", "else"), _, I);
			}
			function De(e, t) {
				return "await" == t ? T(De) : "(" == e ? T(z(")"), We, I) : void 0;
			}
			function We(e) {
				return "var" == e ? T(Se, Ee) : "variable" == e ? T(Ee) : M(Ee);
			}
			function Ee(e, t) {
				return ")" == e
					? T()
			...
			function Ie(e, t) {
				return "variable" == e ? Re(e, t) : _e(e, t);
			}
			function Re(e, t) {
				if ("variable" == e) return A(t), T(_e);
			}
			function _e(e, t) {
				return "<" == t
					? T(z(">"), le(Ce, ">"), I, _e)
					: "extends" == t || "implements" == t || (c && "," == e)
					? ("implements" == t && (L.marked = "keyword"), T(c ? he : j, _e))
					: "{" == e
					? T(z("}"), Be, I)
					: void 0;
			}
			function Be(e, t) {
				return "async" == e ||
					("variable" == e &&
						("static" == t || "get" == t || "set" == t || (c && O(t))) &&
						L.stream.match(/^\s+[\w$\xa1-\uffff]/, !1))
					? ((L.marked = "keyword"), T(Be))
					: "variable" == e || "keyword" == L.style
					? ((L.marked = "property"), T(je, Be))
					: "number" == e || "string" == e
					? T(je, Be)
					: "[" == e
					? T(j, ue, R("]"), je, Be)
			...
			function je(e, t) {
				...
				return M(r && "interface" == r.info ? Fe : He);
			}
			function Ve(e, t) {
				return "*" == t
					? ((L.marked = "keyword"), T(Xe, R(";")))
					: "default" == t
					? ((L.marked = "keyword"), T(j, R(";")))
					: "{" == e
					? T(le(Ge, "}"), Xe, R(";"))
					: M(_);
			}
			...
			function $e(e, t) {
				if ("as" == t) return (L.marked = "keyword"), T(Ke);
			}
			function Xe(e, t) {
				if ("from" == t) return (L.marked = "keyword"), T(j);
			}
			function Ye(e) {
				return "]" == e ? T() : M(le(V, "]"));
			}
			function Ze() {
				return M(z("form"), Le, R("{"), z("}"), le(Qe, "}"), I, I);
			}
			function Qe() {
				return M(Le, Ne);
			}
				...
				(I.lex = !0),
				{
					startState: function (e) {
						var t = {
							...
							context: r.localVars && new D(null, null, !1),
							indented: e || 0
						};
						return (
							r.globalVars &&
	...
	(function (e) {
		...
		function r(e, t) {
			...
			return (
				e instanceof RegExp
					? (e.ignoreCase && (r = "i"), e.unicode && (r += "u"), (e = e.source))
					: (e = String(e)),
				new RegExp((!1 === t ? "" : "^") + "(?:" + e + ")", r)
			);
		}
		...
		function o(t, n, o, l) {
			var a;
			if (o.persistent)
				for (var s = n.persistentStates; s && !a; s = s.next)
					(o.spec ? i(o.spec, s.spec) : o.mode == s.mode) && (a = s);
			var u = a ? a.mode : o.mode || e.getMode(t, o.spec),
			...
			o.persistent &&
				...
				(n.local = {
					...
					endToken: l && l.join ? l[l.length - 1] : l
				});
		}
			...
			(e.simpleMode = function (r, i) {
				...
				for (var u in i)
					if (u != a && i.hasOwnProperty(u))
						for (var c = (l[u] = []), f = i[u], d = 0; d < f.length; d++) {
							var h = f[d];
						...
						return function (r, n) {
							...
							if (n.local) {
								if (n.local.end && r.match(n.local.end)) {
									var l = n.local.endToken || null;
									return (n.local = n.localState = null), l;
								}
								var a,
									l = n.local.mode.token(r, n.localState);
								return (
									n.local.endScan &&
										(a = n.local.endScan.exec(r.current())) &&
										(r.pos = r.start + a.index),
									l
								);
							}
							for (var s = e[n.state], u = 0; u < s.length; u++) {
								var c = s[u],
									f = (!c.data.sol || r.sol()) && r.match(c.regex);
								if (f) {
									c.data.next
										? (n.state = c.data.next)
										: c.data.push
										...
										: c.data.pop &&
										  ...
										  n.stack.length &&
										  (n.state = n.stack.pop()),
										c.data.mode && o(t, n, c.data.mode, c.token),
										c.data.indent &&
											n.indent.push(r.indentation() + t.indentUnit),
										c.data.dedent && n.indent.pop();
									var d = c.token;
									if (
										(d && d.apply && (d = d(f)),
										f.length > 2 && c.token && "string" != typeof c.token)
									) {
										...
										return (
											r.backUp(f[0].length - (f[1] ? f[1].length : 0)), d[0]
										);
									}
							...
							e: for (;;) {
								for (var s = 0; s < a.length; s++) {
									...
									if (u.data.dedent && !1 !== u.data.dedentIfLineStart) {
										var c = u.regex.exec(i);
										if (c && c[0]) {
											l--,
												(u.next || u.push) && (a = t[u.next || u.push]),
				...
				if (a) for (var g in a) a.hasOwnProperty(g) && (p[g] = a[g]);
				return p;
			});
	}),
	(function (e) {
		"object" == typeof exports && "object" == typeof module
			? e(require("../../lib/codemirror"), require("../../addon/mode/simple"))
			: "function" == typeof define && define.amd
			? define(["../../lib/codemirror", "../../addon/mode/simple"], e)
			: e(CodeMirror);
	})(function (e) {
		"use strict";
