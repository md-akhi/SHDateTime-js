...
اشیاء تاریخ جاوا اسکریپت یک لحظه در زمان را در قالبی مستقل از پلتفرم نشان می دهند. اشیاء تاریخ حاوی یک عدد هستند که نشان دهنده میلی ثانیه از 25 دی 1390 UTC است.
