...
متد <code dir = "ltr">setSeconds()</code> ثانیه ها را برای تاریخ مشخص با توجه به زمان محلی تعیین می کند.
امتحان کنید
...
اگر پارامتر `MSValue` را مشخص نکردید ، از مقدار بازگشت از متد <code dir = "ltr">getMilliseconds()</code> استفاده می شود.
