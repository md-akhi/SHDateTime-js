...
[!NOTE] توجه: <code dir="ltr">Date()</code> را می توان با یا بدون new، اما با افکت های مختلف فراخوانی کرد. به مقدار بازگشتی مراجعه کنید.
...
چندین روش برای ایجاد یک شی <code dir="ltr">Date</code>
